<template>
    <div class="box">
        ...
        <h3 class="subtitle is-4">Order PLN</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="pln" hidden>
        ...
        <div class="field">
            ...
            <input name="id_customer" class="input" type="text" placeholder="Nomor meter atau ID PLN Pelanggan" required>
        </div>
        <div class="field">
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/pln')
                .then(response => {
