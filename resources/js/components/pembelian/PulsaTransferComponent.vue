<template>
    <div class="box">
        <h3 class="subtitle is-4">Order Pulsa Transfer</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="pulsa-transfer" hidden>
            ...
            <div class="field">
                <label class="label">Nominal Pulsa Transfer</label>
                <div class="select is-fullwidth">
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/pulsa-transfer')
