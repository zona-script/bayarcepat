<template>
    <div class="box">
        ...
        <form action="/dashboard/transaksi" method="POST">
            ...
            <input name="type" type="text" value="ewallet" hidden>
            ...
            <div class="field">
                <label class="label">Nominal Ewallet</label>
                <div class="select is-fullwidth">
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/ewallet')
