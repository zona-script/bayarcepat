<template>
    <div class="box">
        <h3 class="subtitle is-4">Order Paket Data</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="data" hidden>
            ...
            <div class="field">
                <label class="label">Paket Data</label>
                <div class="select is-fullwidth">
            ...
            <div class="field" v-if="selectedProduct.description">
                <div class="notification is-info">
                     [Provider {{ selectedProduct.provider }}] {{ selectedProduct.operator }} {{ selectedProduct.description }}
                </div>
            </div>
...
<script>
    export default {
        ...
        created() {
            window.axios.get('/api/harga/internet')
