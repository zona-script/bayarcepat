<template>
    <div class="box">
        <h3 class="subtitle is-4">Paket Telepon dan Sms</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="telepon-dan-sms" hidden>
            ...
            <div class="field">
                <label class="label">Paket Telepon dan Sms</label>
                <div class="select is-fullwidth">
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/sms-dan-telepon')
