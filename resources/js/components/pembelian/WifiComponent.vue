<template>
    <div class="box">
        ...
        <h3 class="subtitle is-4">Order Voucher Wifi</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="wifi" hidden>
            ...
            <div class="field">
            <label class="label">Nominal Voucher</label>
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/wifi')
                .then(response => {
