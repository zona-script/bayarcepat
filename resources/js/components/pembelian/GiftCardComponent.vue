<template>
    <div class="box">
        <h3 class="subtitle is-4">Order Gift Card</h3>
        <hr>
        <form action="/dashboard/transaksi" method="POST">
            <input type="hidden" name="_token" :value="csrf">
            <input name="type" type="text" value="gift-card" hidden>
            ...
            <div class="field">
                <label class="label">Penyedia Gift Card</label>
            ...
            <div class="field">
                <label class="label">Nominal Gift Card</label>
                <div class="select is-fullwidth">
...
<script>
    export default {
        ...
        created() {
            ...
            window.axios.get('/api/harga/gift-card')
